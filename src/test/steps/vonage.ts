...
When('I enter my username and password', async function () {
    await pageFixture.page.fill(vonageLoginPage.locators.usernameInput, process.env.USERNAME);
    await pageFixture.page.fill(vonageLoginPage.locators.passwordInput, process.env.PASSWORD);
});
